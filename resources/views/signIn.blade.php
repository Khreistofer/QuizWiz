	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action = "home" method = "post">     {{--form--}}
					@csrf
					...
					@if (session()->has('error'))		
						<div class="txt1 text-center p-t-54 p-b-20" style="margin-top:0%; color:red;"> 
							{{session()->get('error');}} 
						</div>
					@endif
					...
					<div class="flex-c-m">
						...
						<a href="https://gmail.com" class="login100-social-item bg3">
